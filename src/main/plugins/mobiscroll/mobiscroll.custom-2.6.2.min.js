...
g++});h+="</tr></table></div></div>"});h+="</div>"+("inline"!=p.display?'<div class="dwbc'+(p.button3?" dwbc-p":"")+'"><span class="dwbw dwb-c"><span class="dwb dwb-e" role="button" tabindex="0">'+p.cancelText+"</span></span>"+(p.button3?'<span class="dwbw dwb-n"><span class="dwb dwb-e" role="button" tabindex="0">'+p.button3Text+"</span></span>":"")+'<span class="dwbw dwb-s"><span class="dwb dwb-e" role="button" tabindex="0">'+p.setText+"</span></span></div></div>":"")+"</div></div></div>";v=a(h);
